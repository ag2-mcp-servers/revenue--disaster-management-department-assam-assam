...
class CertificateParameters(BaseModel):
    RefNo: str = Field(
        ...,
        description='Application Reference No',
        examples=['Application Reference No'],
    )
...
class NncerCertificatePostRequest(BaseModel):
...
class NncerCertificatePostResponse(BaseModel):
...
class NncerCertificatePostResponse1(BaseModel):
...
class NncerCertificatePostResponse2(BaseModel):
...
class NncerCertificatePostResponse3(BaseModel):
...
class NncerCertificatePostResponse4(BaseModel):
...
class NncerCertificatePostResponse5(BaseModel):
...
class NncerCertificatePostResponse6(BaseModel):
